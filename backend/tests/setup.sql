...
GRANT ALL PRIVILEGES ON wthack_automation_test.* TO 'remote'@'0.0.0.0';
FLUSH PRIVILEGES;
...
LOAD DATA INFILE '/var/lib/mysql-files/user_test.csv' INTO TABLE `user`
...
load data infile '/var/lib/mysql-files/grp_test.csv' into table `grp` 
fields terminated by ',' enclosed by '"'
lines terminated by '\n' ignore 1 lines;
...
load data infile '/var/lib/mysql-files/tool_test.csv' into table `tool` 
...
load data infile '/var/lib/mysql-files/event_test.csv' into table `event` 
fields terminated by ','
enclosed by '"'
lines terminated by '\n'
ignore 1 lines;
...
load data infile '/var/lib/mysql-files/comm_test.csv' into table `comm` 
fields terminated by ','
enclosed by '"'
lines terminated by '\n'
ignore 1 lines;
...
load data infile '/var/lib/mysql-files/event_comm_test.csv' into table `event-comm` 
fields terminated by ','
enclosed by '"'
lines terminated by '\n'
ignore 1 lines;
